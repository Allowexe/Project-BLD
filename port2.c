...
/*void dessinAeroport(int numParkG, int numParkM, int numPark)
{
    // piste moyenne
    printf("                                         +--------------------------------------------------------------+\n");                      // 106
    printf("                                         |                                                              |\n");                      // 106
    printf("                                         |%s -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -%s|\n", YELLOW, DEFAULT); // 16 & 110
    printf("                                         |                                                              |\n");                      // 106
    printf("                                         +--------------------------------------------------------------+\n");                      // 106
    ...
    // piste petite
    printf("                                                             +------------------------------------------+\n");                      // 106
    printf("                                                             |%s -   -   -   -   -   -   -   -   -   -   -%s|\n", YELLOW, DEFAULT); // 11 & 110
    printf("                                                             +------------------------------------------+\n");                      // 106
    // park
    printf("\n");
    printf("                      %s[ ]     [ ]     [ ]     [ ]     [ ]     [ ]     [ ]%s                               \n", BWHITE, DEFAULT); // 109 parking moyen
    printf("                      %s[ ]     [ ]     [ ]     [ ]     [ ]     [ ]     [ ]%s                               \n", BWHITE, DEFAULT); // 109 parking petit
    printf("                      %s[ ]     [ ]     [ ]     [ ]     [ ]     [ ]     [ ]%s                               \n", BWHITE, DEFAULT); // 109
    printf("\n");
    // grande piste
    printf("                    +-----------------------------------------------------------------------------------+\n");                      // 106
    printf("                    |                                                                                   |\n");
    printf("                    |                                                                                   |\n");                      // 106
    printf("                    |%s -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   - %s|\n", YELLOW, DEFAULT); // 21 &  110 parking grand
    printf("                    |                                                                                   |\n");
    printf("                    |                                                                                   |\n");                      // 106
    printf("                    +-----------------------------------------------------------------------------------+\n");                      // 106
}*/
...
char *bordPpiste = "                                                             +------------------------------------------+\n" ;
char *pointillePPiste = "                                                             |%s -   -   -   -   -   -   -   -   -   -   -%s|\n" ; //64 saut 10

char *BordMPiste = "                                         +--------------------------------------------------------------+\n" ;
char *milieuMPiste = "                                         |                                                              |\n" ;
char *pointilleMPiste = "                                         |%s -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -%s|\n" ; //  44  saut av 14
*/

void dessinAeroport(int numParkG, int numParkM, int numParkP, int numTaxiG, int numTaxiM, int numTaxiP)
{
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        sprintf(BufferParkG, GParking, BWHITE,
                ((numParkG >= 7) ? PLANE : VIDE), ((numParkG >= 6) ? PLANE : VIDE), ((numParkG >= 5) ? PLANE : VIDE), ((numParkG >= 4) ? PLANE : VIDE), ((numParkG >= 3) ? PLANE : VIDE), ((numParkG >= 2) ? PLANE : VIDE), ((numParkG >= 1) ? PLANE : VIDE), DEFAULT);

        sprintf(BufferParkM, MParking, BWHITE,
                ((numParkM >= 7) ? PLANE : VIDE), ((numParkM >= 6) ? PLANE : VIDE), ((numParkM >= 5) ? PLANE : VIDE), ((numParkM >= 4) ? PLANE : VIDE), ((numParkM >= 3) ? PLANE : VIDE), ((numParkM >= 2) ? PLANE : VIDE), ((numParkM >= 1) ? PLANE : VIDE), DEFAULT);

        sprintf(BufferParkP, PParking, BWHITE,
                ((numParkP >= 7) ? PLANE : VIDE), ((numParkP >= 6) ? PLANE : VIDE), ((numParkP >= 5) ? PLANE : VIDE), ((numParkP >= 4) ? PLANE : VIDE), ((numParkP >= 3) ? PLANE : VIDE), ((numParkP >= 2) ? PLANE : VIDE), ((numParkP >= 1) ? PLANE : VIDE), DEFAULT);

        sprintf(BufferGPiste, pointillerGPiste,
                ((numTaxiG >= 3) ? PLANE : "_"), ((numTaxiG >= 2) ? PLANE : "_"), ((numTaxiG >= 1) ? PLANE : "_"), YELLOW, ((i == 0) ? PLANE : VIDE), ((i == 1) ? PLANE : VIDE), ((i == 2) ? PLANE : VIDE), ((i == 3) ? PLANE : VIDE), ((i == 4) ? PLANE : VIDE), DEFAULT);

        sprintf(BufferMPiste, pointilleMPiste,
                ((numTaxiM >= 5) ? PLANE : "_"), ((numTaxiM >= 4) ? PLANE : "_"), ((numTaxiM >= 3) ? PLANE : "_"), ((numTaxiM >= 2) ? PLANE : "_"), ((numTaxiM >= 1) ? PLANE : "_"), YELLOW, ((i == 0) ? PLANE : VIDE), ((i == 1) ? PLANE : VIDE), ((i == 2) ? PLANE : VIDE), ((i == 3) ? PLANE : VIDE), ((i == 4) ? PLANE : VIDE), DEFAULT);

        sprintf(BufferPPiste, pointillePPiste,
                ((numTaxiP >= 7) ? PLANE : "_"), ((numTaxiP >= 6) ? PLANE : "_"), ((numTaxiP >= 5) ? PLANE : "_"), ((numTaxiP >= 4) ? PLANE : "_"), ((numTaxiP >= 3) ? PLANE : "_"), ((numTaxiP >= 2) ? PLANE : "_"), ((numTaxiP >= 1) ? PLANE : "_"), YELLOW, ((i == 0) ? PLANE : VIDE), ((i == 1) ? PLANE : VIDE), ((i == 2) ? PLANE : VIDE), ((i == 3) ? PLANE : VIDE), ((i == 4) ? PLANE : VIDE), DEFAULT);
